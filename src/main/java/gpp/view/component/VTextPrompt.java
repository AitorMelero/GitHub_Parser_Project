...
// Autor -> Rob Camick
// Fuente del código -> https://tips4java.wordpress.com/2009/11/29/text-prompt/
 ...
 * class construction.
 */
public class VTextPrompt extends JLabel implements FocusListener, DocumentListener {
	public enum Show {
	...
	public VTextPrompt(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public VTextPrompt(String text, JTextComponent component, Show show) {
